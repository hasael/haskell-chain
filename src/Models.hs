...
newtype HashValue = HashValue {hashValue :: String}   deriving (Show, Generic, FromJSON, ToJSON, Eq, FromHttpApiData)
...
newtype BlockIndex = BlockIndex {blockIndex :: Int}   deriving (Show, Generic, FromJSON, ToJSON, Eq, FromHttpApiData)
